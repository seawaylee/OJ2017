package nowcoder.wy_2017_spring._3_exchange_queue;
...
public class Main
{
    ...
    //    int gSum = 0, bSum = 0, gIndex = 0, bIndex = 0;
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(Math.min(bSum - bCount * (bCount - 1) / 2,gSum - gCount * (gCount - 1) /2 ));
